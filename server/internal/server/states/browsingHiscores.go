...
func (b *BrowwsingHiscores) Name() string {
	return "BrowsingHiscores"
}

func (b *BrowwsingHiscores) SetClient(client server.ClientInterfacer) {
	b.client = client
...
func (b *BrowwsingHiscores) OnEnter() {
...
func (b *BrowwsingHiscores) HandleMessage(senderId uint64, message packets.Msg) {
}

func (b *BrowwsingHiscores) OnExit() {
